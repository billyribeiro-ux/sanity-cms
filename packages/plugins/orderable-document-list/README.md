...
To run this plugin locally and develop, it uses the internal test studio used by the Development teams. You need to run install and pnpm run dev and you will have a clear and easy example to use.
